  ...
  return (
    <div>
      <h2 style={{ fontSize: 24, marginBottom: 4 }}>
        Buyer / DPP verification
      </h2>
      <p className="muted small" style={{ marginBottom: 24 }}>
        Look up a unit&rsquo;s Digital Product Passport, or paste a verification
        ID from a QR code.
      </p>
      ...
      <div style={{ display: "flex", gap: 24 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {!selected && (
            <p className="muted small">Select a unit to view its passport.</p>
          )}
          {selected && dpp && (
            <div className="card">
              ...
              <p className="small muted" style={{ margin: 0 }}>
                ...
                {dpp.recent_environmental_evidence.status}
              </p>
              <div
                style={{
                  display: "flex",
